      ...
      <main className={styles.main}>
        <section className={styles.info}>
          ...
          <section className={styles.sac}>
            ...
            <span>
              <p>
                En UTURI, nos apasiona brindar experiencias de viaje
                inolvidables y descubrir nuevos destinos junto a nuestros
                clientes. Somos un equipo de entusiastas viajeros y guías
                expertos que estamos comprometidos en proporcionar los mejores
                tours y servicios de calidad. <br />
                <br />
              ...
              <img
                src={require("../../images/quienes_somos/proposito.jpg")}
                alt=""
              />
            </span>
          </section>
          <aside>
            ...
            <article>
              ...
              <figure>
                <img
                  src={require("../../images/quienes_somos/cliente.jpg")}
                  alt=""
                />
              ...
              <figure>
                <img
                  src={require("../../images/quienes_somos/equipo.jpg")}
                  alt=""
                />
