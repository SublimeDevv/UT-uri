            ...
            <main className={styles.main}>
                <section className={styles.info}>
                    <div className={styles.ruta}>
                        <Link href="categorias.html" className={styles.a1}>Categorias</Link>
                        <p>»</p>
                        <Link href="natural.html" className={styles.a1}>Listas</Link>
                        <p>»</p>
                        <Link href="detalles.html" className={styles.a1}>Detalles</Link>
                        <p>»</p>
                        <Link href="#" className={styles.a2}>Pago</Link>
                    </div>
